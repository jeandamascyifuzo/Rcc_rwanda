...
const LessonOfDay = () => {
  ...
  const data = [
    ...
    {
      id: 5,
      image: "https://cdn.pixabay.com/photo/2013/03/20/17/00/office-95311__480.jpg",
      title: "In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content",
      content: "In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available,In publishing and graphic design, Lorem ipsum is a placeholder text commonly used to demonstrate the visual form of a document or a typeface without relying on meaningful content. Lorem ipsum may be used as a placeholder before final copy is available."
    }
  ]
      ...
      <div className="bg-[#F5F5F5] pb-10 min-h-screen lg:ml-44">
        <div className="flex items-left px-7 lg:px-28 pt-14 pb-8">
          <div className="space-x-8">
            <button className="text-white font-serif font-semibold bg-blue-700 hover:bg-transparent border border-blue-700 hover:text-black focus:ring-4 focus:outline-none  font-medium rounded-lg text-base uppercase px-5 py-2.5 mt-8 text-center mr-3 md:mr-0 uppercase cursor-pointer" onClick={removeModel}>lesson +</button>
          </div>
        </div>
                    ...
                    <tbody>
                      {data.map((item) => (
                        <tr key={item.id}>
                          ...
                          <td className="px-5 py-5 border-b border-gray-200 bg-white text-sm">
                            <p className="text-gray-900 whitespace-no-wrap line-clamp-4">{item.content}</p>
                          </td>
